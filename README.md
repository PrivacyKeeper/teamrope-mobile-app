# Team Roping — mobile app

Find the partner. Know the number.

Companion app for [teamrope.pro](https://www.teamrope.pro). Expo + expo-router,
Supabase, TypeScript.
...
Sanctioning bodies that matter here: USTRC, WSTR, PRCA, ACTRA.
